...
vim.cmd([[highlight Pmenu guibg=none blend=20]])
...
vim.api.nvim_set_hl(0, "GitsignsAddInline", {fg="#000000",bg="#aaffaa"})
vim.api.nvim_set_hl(0, "GitsignsChangeInline", {fg="#000000",bg="#aaffaa"})
vim.api.nvim_set_hl(0, "GitsignsDeleteInline", {fg="#000000",bg="#ffaaaa"})
